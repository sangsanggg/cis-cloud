    ...
    <div class="container h-100">
        <div class="row">
            ...
            <div class="col-lg-5 m-auto">
                ...
                <input type="password" id="inputPassword5" name="password" class="form-control" placeholder="Enter Password">
               <div id="passwordHelpBlock" class="form-text">
                ...
                <select class="form-select" name="role" id="form-select"aria-label="Default select example">
                  ...
                  <button type="submit" id="myButton" class="btn btn-secondary button-signin fs-5">Login</button>
