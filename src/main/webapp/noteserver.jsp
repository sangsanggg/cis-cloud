<%-- 
    Document   : noteserver
    Created on : Nov 28, 2022, 6:04:55 PM
    Author     : SANGSANG
--%>
...
<!--            <div class="form-group">
              ...
              <div class="mb-3">
                     <textarea class="form-control" id="exampleFormControlTextarea1" rows="15" name="note"><%=res1.getString("note_server")%></textarea>
              </div>
 </div>
            <%
               }
...
<%
    ...
    if(a!=null && b!=null){
    String query = "UPDATE server set note_server=? where server_id='"+a+"'";
